    ...
    <div className="md:pl-10">
        ...
        <div className=''>
            {businessList.map((business,index)=>(
                <Link href={'/details/'+business.id} className='flex gap-2 mb-4 hover:border rounded-lg p-2 border-primary cursor-pointer hover:shadow-md'>
                  
                    <Image src={business?.images[0].url} alt={business.name} width={100} height={80} className='rounded-lg object-cover'/>
